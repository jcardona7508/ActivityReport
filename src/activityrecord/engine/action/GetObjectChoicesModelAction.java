...
public class GetObjectChoicesModelAction extends DefaultHandler {
  ...
  public EventResponse execute(ApplicationEvent event) throws GausssoftException {
    ...
    String activityCode = event.getRequest().getParameter("name");
    ...
    try {
      ...
      if (resourceCode != null) {
        ...
        List list = RactDAO.getActivityObjects(resourceCode, 
            activityCode, 
            AND, 
            sqlManager);
