...
public class HTMLResourceColumns extends HTMLSelectSC {
  public HTMLResourceColumns(Session session) {
    String[] localValues = new String[0];
    localValues = new String[5];
    localValues[0] = "ACTIVITY.ACUM,ACUM.NOMBRE,ACUM.TIPO,ACUM.UNIDAD,SREC.USUA";
