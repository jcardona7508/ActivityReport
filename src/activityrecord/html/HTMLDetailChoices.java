...
public class HTMLDetailChoices implements HTMLContentSC, Serializable {
  List choices;
  
  ResourceString resourceString;
  
  public HTMLDetailChoices(List objects, ResourceString resourceString) {
  ...
  public void getHTMLContent(HTMLBuffer buffer) {
    ...
    for (int i = 0; i < this.choices.size(); i++) {
      buffer.appendLine("  <tr>");
      DetailChoiceTO choice = (DetailChoiceTO) this.choices.get(i);
